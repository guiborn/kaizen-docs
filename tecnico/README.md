...
|---|---|
| **Gestão de Obras** | Planejamento, controle de produtividade, qualidade, custos, cotações e materiais por obra |
...
| [02 — Módulos Gestão de Obras](./02_modulos_gestao_obra.md) | Todos os módulos da plataforma de obras (~26 funcionalidades, incluindo Cotações — §6.2) |
| [03 — Módulo Assistência Técnica](./03_modulo_assistencia_tecnica.md) | AT: work orders, agendamentos, colaboradores, analytics |
| [04 — Módulo Cotações](./04_modulo_cotacoes.md) | ↳ Integrado ao Módulo de Gestão de Obras — ver [§6.2 Cotações](./02_modulos_gestao_obra.md#62-cotações) |
| [05 — Integrações Externas](./05_integracoes.md) | Salesforce CRM, Prevision, Azure Synapse, Mega ERP |
